...
export default function MultipleChoice(props) {
    ...
    if (isAdded) { 
        ...
        return (
            <div style={{margin: '25px 0 0 0'}} onClick={toggleEditing}>
                <div className="row top-form" data-index={mainIndex}>
                    <div className="input-field col s12">
                        <input id={`multiple-choice-${_id}`} disabled
                            ...
                            readOnly
                        />
                        <label htmlFor={`multiple-choice-${_id}`}
                            data-index={mainIndex}
            ...
            <div>
                <div className="row">
                    <div className="input-field col s12">
                        ...
                        {
                            question ? 
                                <label style={{fontSize: 25}} htmlFor={`multiple-choice-${_id}`} className="active">Question</label> :
                                <label style={{fontSize: 25}} htmlFor={`multiple-choice-${_id}`}>Question</label>
                        }
                    </div>
                </div>
                {
