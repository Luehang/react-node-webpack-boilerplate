            ...
            <div onClick={toggleEditing}>
                <div className="row top-form" style={{margin: '25px 0 0 0'}} data-index={mainIndex}>
                    <div className="input-field col s12">
                        <input id={`dropdown-${_id}`} disabled
                ...
                if (i == 0) {
                    return (
                        <p key={i} style={{margin: 0}}>
                            <label className="row">
                                <span className="left grey-text text-darken-3" style={{fontSize: 20,margin: 0,paddingRight: 5}}>1.</span>
            ...
            <div>
                <div className="row">
                    <div className="input-field col s12">
                        ...
                        {
                            question ? 
                                <label style={{fontSize: 25}} htmlFor={`dropdown-${_id}`} className="active">Question</label> :
                                <label style={{fontSize: 25}} htmlFor={`dropdown-${_id}`}>Question</label>
                        }
                    </div>
                </div>
                {
