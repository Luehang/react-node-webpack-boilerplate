        ...
        return (
            <div className="row" style={{margin: '25px 0 0 0'}} onClick={toggleEditing}>
                <div className="input-field col s12 top-form" data-index={mainIndex}>
                    ...
                    />
                    <label style={{fontSize: 25}} htmlFor={`date-${_id}`} className={`${red} active`} data-index={mainIndex}>Question</label>
                </div>
                {
                    isDescription ? 
                        <Description
                ...
                <div className="row">
                    <div className="input-field col m5 s6" style={{marginTop: -5}}>
                        <i className="small material-icons prefix grey-text text-dark-3" data-index={mainIndex}>date_range</i>
                        <input disabled id="icon_prefix" placeholder="Month,day,year" style={{fontSize: 14}} type="text" data-index={mainIndex} />
            ...
            <div>
                <div className="row">
                    <div className="input-field col s12 top-form">
                        ...
                        {
                            question ? 
                                <label style={{fontSize: 25}} htmlFor={`date-${_id}`} className="active">Question</label> :
                                <label style={{fontSize: 25}} htmlFor={`date-${_id}`}>Question</label>
                        }
                    </div>
                </div>
                {
